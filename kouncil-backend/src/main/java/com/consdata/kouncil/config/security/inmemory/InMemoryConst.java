...
public final class InMemoryConst {
    ...
    public static final String ADMIN_DEFAULT_ROLE = "admin_role";
    ...
    public static final String EDITOR_DEFAULT_ROLE = "editor_role";
    ...
    public static final String VIEWER_DEFAULT_ROLE = "viewer_role";
